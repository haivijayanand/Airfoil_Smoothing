function [XNew,YNew]= unpa_smoother(x,y) 
% Modified as a function to smoothen the given airfoil coordinates
% By K.Vijay Anand, haivijayanand@gmail.com
%
% -------------------------------------------------------------------------
...
% Get Airfoil Coordinates in Same Number of Points as Original

XNew_upper = xu;
XNew_lower= xl;
YNew_upper = interp1(M(:,1),M(:,2),xu,'spline');
YNew_lower= interp1(M(:,1),M(:,3),xl,'spline');

XNew = x;
YNew = [YNew_upper(end:-1:2) YNew_lower]
